...
# application icon
icon = D:\Python_work\math-drawing-assistant\.venv\Lib\site-packages\PySide6\scripts\deploy_lib\pyside_icon.ico

[python]

# python path
python_path = D:\Python_work\math-drawing-assistant\.venv\Scripts\python.exe
